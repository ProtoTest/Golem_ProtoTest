...
{
    public class LetsTalkTestingTests : WebDriverTestBase
    {
                public string envUrl = Config.GetConfigValue("EnvironmentUrl", "htt://www.prototest.com");

        //[Test]
        //public void VerifyLetsTalkTestingContainerDisplays()
        //{
        //    OpenPage<HomePage>(envUrl)
        //    .header.SelectLetsTalkTestingMenuOption()
        //    .VerifyStepOneTextDisplayed();
        //}
    }
}
